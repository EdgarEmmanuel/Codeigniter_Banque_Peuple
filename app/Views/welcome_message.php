...
<html lang="en">
	...
	<body>
		<div class="textcontain">
			<span class="text1">Emmanuel Edgar</span>
			<span class="text2">Responsable des Comptes</span>
		</div>
		<?php echo base_url('app/Controllers/ClientCourantController.php')?>"
		...
		<div
			...
			<div class="donneesClientSimple">
				<form action="<?php echo base_url('app/Controllers/ClientSimpleController.php');?>" method="POST">
					<fieldset class="dataClient" id="forCompteSimple">
						...
						<input type="date" name="dateNaiss" id="dateNaissSimple" required><br><br>
			...
			<form action="<?php echo base_url('app/Controllers/ClientCourantController.php');?>" method="POST">
